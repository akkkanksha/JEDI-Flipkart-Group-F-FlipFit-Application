...
public interface IFlipFitGymOwnerDAO {
    ...
    /**
     addCentre - It is a method which adds a new gym centre for the gym owner.
     It takes centre as parameter and FlipFitGymCentre object representing the gym centre to be added.
     It returns true if the gym centre is successfully added, false otherwise.
     */
    ...
    /**
     ...
     It returns a A List of FlipFitGymCentre objects representing the gym centres owned by the specified owner.
     */
